            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                      <input type="radio" value="1" name="acc_type" id="acc_type1" class="form-check-input" @isset($user->acc_type) @if($user->acc_type == "1") checked @endif @endisset required>
                      <label class="form-check-label" for="acc_type1">{{ __("Employee") }}</label>
                    </div>

                    <div class="form-check">
                      <input type="radio" value="2" name="acc_type" id="acc_type2" class="form-check-input" @isset($user->acc_type) @if($user->acc_type == "2") checked @endif @endisset required>
