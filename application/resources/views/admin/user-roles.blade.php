        ...
        <div class="col-md-12 page-header">
            <div class="row g-1">
                ...
                <div class="col-md-6 mb-1 text-end">
                    <a href="{{ url('/admin/users') }}" class="btn btn-outline-primary btn-sm me-2">
                        <i class="fas fa-arrow-left"></i><span class="button-with-icon">{{ __("Return") }}</span>
                    </a>

                    <a href="{{ url('admin/user/roles/add') }}" class="btn btn-outline-primary btn-sm">
                    ...
                    @isset($roles)
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href="#" data-url="{{ url('/admin/user/roles/delete') }}/{{ $role->id }}" class="btn btn-outline-secondary btn-sm btn-rounded btnDelete" data-bs-toggle="modal" data-bs-target="#confirmationModal">
